...
@Mod("ferritymod")
public class FerritymodMod {
	public static final Logger LOGGER = LogManager.getLogger(FerritymodMod.class);
	public static final String MODID = "ferritymod";
	...
	public FerritymodMod(IEventBus modEventBus) {
		...
		FerritymodModItems.REGISTRY.register(modEventBus);
		FerritymodModEntities.REGISTRY.register(modEventBus);
